...
// declara la funcion handleNewChat
  ...
  await createChat("Nuevo Chat");   // llama a la función createChat del archivo chat.ts y le pasa "nuevo chat"
    ...
    <div className="lacasa">
      ...
      <div className="contenedor">
        ...
        <main className="mainchatbot">
          {activeChat && messages.length === 0 &&( <h1 className="titulochatbot">Creá, entrená, optimizá. ¿Por dónde empezamos?</h1>)}
